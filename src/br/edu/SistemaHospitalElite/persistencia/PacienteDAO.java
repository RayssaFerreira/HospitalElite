...
public class PacienteDAO {
    ...
    //private static final String SQL_BUSCAR_BY_CPF = "SELECT * FROM PACIENTE WHERE CPF = ?";
     ...
     private static final String SQL_REMOVER_PACIENTE = "DELETE FROM PACIENTE WHERE NOME = ?";
     private static final String SQL_UPDATE = "UPDATE PACIENTE SET NOME=?, CPF=? WHERE CPF=?";
    ...
    public List<Paciente> buscarTodosCpf(Paciente filtro) throws SQLException {
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                paciente.setIdade(resultado.getInt(4));
                paciente.setRenda(resultado.getDouble(5));
